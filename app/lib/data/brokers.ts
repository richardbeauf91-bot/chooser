...
export const brokers: Broker[] = [
  ...
  // ═══════════════════════════════════════════════════════
  {
    ...
    review: {
      ...
      costs: "CMC Markets generally charges through spreads and financing rather than high entry fees. Forex spreads are competitive on major pairs. CFDs have broad coverage with tight pricing on indices and FX; share CFD fees vary. No minimum deposit requirement. Overnight financing costs apply to leveraged positions. An inactivity fee of £10 per month is charged after 12 consecutive months of no trading activity. Costs overall are transparent and competitive in core markets, though fees on share CFDs and other instruments may be higher than some niche low-cost brokers.",
