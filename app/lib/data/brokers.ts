...
export const brokers: Broker[] = [
  ...
  // ═══════════════════════════════════════════════════════
  {
    ...
    review: {
      ...
      faq: [
        ...
        { question: "Can I trade options and futures?", answer: "Yes — listed options and futures are available, making Saxo one of very few retail brokers to offer this alongside standard equities and CFDs." },
      ],
      methodology: "This review is based on publicly available product information, FCA register data, fee schedules, and user review platforms. It is not financial advice. Affiliate relationships do not influence evaluation.",
    },
  },
  ...
  // ═══════════════════════════════════════════════════════
  {
    ...
    longDescription: "Tickmill is an FCA-regulated CFD and forex broker known for its low-cost execution model. Its Pro account offers raw interbank spreads plus a low per-lot commission, making it competitive for high-frequency and active forex traders. MT4 and MT5 are both supported, along with a web trader and mobile app. It does not offer stocks or ETFs but excels within its core focus of forex and CFD execution.",
    availabilityCountries: ["UK", "EU", "Global"],
    ...
    review: {
      ...
      platforms: "Tickmill supports MetaTrader 4 (MT4), MetaTrader 5 (MT5), a web-based platform, and mobile trading apps. MT4 and MT5 support automated trading, expert advisors (EAs), and a wide range of custom indicators. The web trader provides a streamlined browser-based option for traders who do not wish to install desktop software.",
      ...
      faq: [
        ...
        { question: "Is the Raw account worth it?", answer: "For traders placing 5+ lots per month, the Raw account (0.0 pip spread + $3/side commission) typically results in a lower total cost than the Classic spread-only account." },
      ],
