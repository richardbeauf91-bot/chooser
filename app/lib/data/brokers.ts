...
export const brokers: Broker[] = [
  ...
  // ═══════════════════════════════════════════════════════
  {
    ...
    longDescription: "Trading 212 is a UK-based, FCA-regulated platform that popularised zero-commission stock and ETF investing in the UK. It offers a Stocks & Shares ISA, a general invest account, and a CFD account — all within a single app. Its £1 minimum deposit and fractional share trading make it one of the most accessible brokers for new investors.",
    availabilityCountries: ["UK", "EU"],
    regulators: ["FCA"],
    ...
    review: {
      ...
      faq: [
        ...
        { question: "What is the minimum deposit?", answer: "£1 for all account types." },
  ...
  // ═══════════════════════════════════════════════════════
  {
    ...
    cons: [
      "Fewer instruments than multi-asset brokers — focused on forex and indices",
      "No stocks, ETFs, or direct equity trading",
    ...
    review: {
      verdict: {
        ...
        notIdealFor: [
          "Traders who want stocks, ETFs, or a broader multi-asset offering",
          "Beginners who need extensive educational hand-holding",
          "Those who need MT5 or cTrader platform support",
        ],
      },
      whoFor: [
      ...
      overview: "OANDA occupies a well-established position in the UK forex market. Its long regulatory history, FCA authorisation, and focus on core forex and index trading make it a reliable choice for dedicated forex traders. It is not a multi-asset platform and does not offer stocks or ETFs, but within its focus area it competes well on pricing and platform quality.",
      strengths: [
        ...
        "OANDA Trade platform is well-regarded for its charting and analytics.",
        "Extensive historical price data available — useful for backtesting strategies.",
      ],
      limitations: [
        "Asset range is narrow compared to multi-asset platforms — no stocks, ETFs, or bonds.",
        ...
        "No MT5 support — MT4 only for the MetaTrader platform.",
      ],
      ...
      whenToAvoid: "If you want a broad multi-asset platform including stocks and ETFs, or if you require MT5 or cTrader, OANDA is not the right fit.",
      platforms: "OANDA offers its own OANDA Trade platform — available via desktop web and mobile (iOS/Android). The platform features advanced charting tools, a range of technical indicators, and is generally well-reviewed for usability among forex traders. MT4 is also available for traders who prefer the MetaTrader ecosystem. MT5 is not currently supported.",
      ...
      assetCoverage: "OANDA focuses primarily on forex — offering over 70 currency pairs — plus a range of major global indices, commodities (metals, oil), and bond CFDs. There are no stocks, ETFs, or crypto CFDs available for UK clients.",
      ...
      faq: [
        ...
        { question: "Is MT4 available?", answer: "Yes — MT4 is available alongside OANDA's own trading platform." },
        { question: "Are stocks and ETFs available?", answer: "No — OANDA focuses on forex, indices, commodities, and bonds only." },
      ],
  ...
  // ═══════════════════════════════════════════════════════
  {
    ...
    cons: [
      "Higher minimum deposit (£500) than most retail brokers",
    ...
    review: {
      ...
      overview: "Saxo Bank stands apart from most retail brokers by the sheer breadth of what it offers. Stocks, ETFs, bonds, options, futures, forex, and CFDs — all within a single account structure, with ISA and SIPP available. Its SaxoTraderPRO platform is genuinely professional-grade. The trade-off is a higher minimum deposit, steeper entry-level pricing, and a platform that is not appropriate for inexperienced traders.",
      strengths: [
      ...
      limitations: [
        "£500 minimum deposit and higher Classic-tier pricing make it less competitive for smaller accounts.",
        ...
        "Account maintenance fees apply if minimum balance thresholds are not maintained.",
      ],
      ...
      costs: "Saxo uses a tiered pricing model across Classic, Platinum, and VIP tiers. Stock trading commissions start at 0.1% (min £3) at Classic level and reduce significantly at higher tiers. Forex spreads on major pairs are competitive at higher tiers. ETFs incur standard dealing commissions. Bonds and structured products have their own pricing. There is an account maintenance fee if the account balance falls below a certain level. The cost structure is worth modelling carefully against your expected trading activity and portfolio size.",
      ...
      faq: [
        ...
        { question: "What is the minimum deposit?", answer: "£500 for a Classic account. Platinum requires a higher balance to qualify." },
  ...
  // ═══════════════════════════════════════════════════════
  {
    ...
    feeModel: "Classic (spread-only) or Pro/VIP (raw spread + low commission)",
    minDeposit: "£100",
    pros: [
      "FCA regulated with a clear focus on execution quality",
      "Pro account raw spreads + $2/side per lot commission — highly competitive for active traders",
    ...
    review: {
      verdict: {
        ...
        notIdealFor: [
          ...
          "Beginners who need extensive educational resources and hand-holding",
      ...
      strengths: [
        "Pro account raw spreads (EUR/USD from 0.0 pips) with $2/side per lot commission — extremely competitive total cost.",
      ...
      costs: "Tickmill offers three account types. Classic: spread-only pricing, typical EUR/USD spread around 1.6 pips. Pro: raw interbank spreads from 0.0 pips plus $2 per side per lot ($4 round-turn) commission. VIP: same raw spreads with reduced commission ($1 per side) but requires a higher deposit. For active traders placing multiple lots per day, the Pro account typically outperforms spread-only accounts significantly. Overnight financing applies on all positions held past rollover.",
      ...
      costComparison: "On a Pro account, Tickmill's round-turn commission of $4/lot on raw spreads makes it one of the most cost-effective FCA-regulated forex brokers. EUR/USD total cost (spread + commission) is typically lower than most standard-account spread-only brokers and competitive with Pepperstone Razor and FP Markets Raw.",
      risks: [
      ...
      faq: [
        ...
        { question: "Is the Pro account worth it?", answer: "For traders placing 5+ lots per month, the Pro account typically results in a lower total cost than the Classic spread-only account." },
      ],
