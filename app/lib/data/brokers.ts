...
export const brokers: Broker[] = [
  ...
  // ═══════════════════════════════════════════════════════
  {
    ...
    minDeposit: "£500 (indicative — verify on Saxo's site)",
    pros: [
    ...
    cons: [
      "Higher entry minimum deposit than most retail brokers",
      "0.12% annual custody fee on stocks, ETFs and bonds at Classic and Platinum tiers",
    ...
    review: {
      ...
      costs: "Saxo uses a tiered pricing model across Classic, Platinum, and VIP tiers. Stock and ETF dealing commissions reduce significantly at higher tiers. In addition to dealing commissions, a custody fee applies: 0.12% per year on stocks, ETFs, and bonds at Classic and Platinum tiers; 0.08% at VIP tier. This custody fee is an important ongoing cost that is easy to overlook. Forex and CFD spreads are competitive at higher tiers. The full cost structure is worth modelling carefully against your expected portfolio size and trading frequency before committing.",
