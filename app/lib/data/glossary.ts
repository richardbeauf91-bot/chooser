...
export const glossary: GlossaryEntry[] = [
...

  {
    ...
    howItWorks: "1) When you send or receive crypto, the transaction is broadcast to a network of computers (nodes).\n2) These nodes validate the transaction using cryptographic rules specific to that blockchain.\n3) Valid transactions are grouped into a block.\n4) The block is added to the chain — permanently recording the transaction.\n5) Every node on the network holds a copy of the full chain.\n6) Because all copies must agree (consensus), altering one record requires controlling the majority of the network — which is impractical on large blockchains like Bitcoin or Ethereum.",
    whyThisMattersForTraders: "When you buy crypto on an exchange like Coinbase or Kraken, the exchange holds your assets in its own wallets and records your balance in its internal database — not on the blockchain directly. If the exchange fails, your balance exists only in their records. Understanding this distinction explains why some users prefer to withdraw crypto to a personal wallet, where ownership is recorded on the blockchain itself and controlled solely by the holder of the private key.",
    commonMisunderstandings: "• All blockchains are the same: they differ in consensus mechanism, transaction speed, fees, and security.\n• Blockchain means anonymous: most blockchains are pseudonymous — transactions are public and traceable.\n• Blockchain is only for crypto: it has many applications, but in the context of this site it primarily underpins crypto assets.\n• Transactions can be reversed: blockchain records are final — there is no chargeback mechanism.\n• The blockchain holds your coins: your coins are represented as records on the blockchain; they don't 'sit' anywhere physically.",
...

  {
    slug: "crypto-wallet",
    term: "Crypto Wallet",
    intent: "Help users understand what a crypto wallet is, the difference between custodial and non-custodial wallets, and why wallet choice matters when selecting a crypto exchange.",
    directAnswer: "A crypto wallet is a tool that stores the cryptographic keys needed to access and transfer your cryptocurrency. It does not store coins directly — it stores the private key that proves ownership of assets recorded on the blockchain. Wallets come in custodial form (the exchange holds your keys) and non-custodial form (you control your own keys). The distinction is fundamental to understanding custody risk when choosing a platform.",
    ...
    howItWorks: "1) The blockchain records which address holds which assets.\n2) Each address is controlled by a corresponding private key — a long cryptographic string.\n3) A wallet generates and stores that private key.\n4) When you want to send crypto, the wallet uses the private key to sign the transaction.\n5) Custodial wallets (like those on Coinbase or Kraken) store the private key on your behalf.\n6) Non-custodial wallets (like MetaMask or a hardware wallet) give you full control.\n7) Whoever holds the private key controls the assets — 'not your keys, not your coins.'",
    whyThisMattersForTraders: "When you hold crypto on an exchange, the exchange is the custodian — they hold your keys. If the exchange fails, is hacked, or freezes withdrawals, you cannot access your assets independently. Moving crypto to a non-custodial wallet transfers control to you, removing exchange risk but introducing personal responsibility for keeping the private key secure. Most retail users leave assets on exchanges for convenience; understanding the trade-off is key to an informed decision.",
    commonMisunderstandings: "• Wallets store your coins: they store your keys; the coins exist on the blockchain.\n• All wallets are the same: custodial vs non-custodial is a fundamental difference.\n• Losing your phone means losing your crypto: for non-custodial wallets, your seed phrase allows restoration on any device.\n• Hardware wallets are un-hackable: they are highly secure but can be lost, damaged, or compromised if seed phrases are exposed.\n• Exchange wallets are as secure as hardware wallets: they are not — exchange wallets are custodial and carry counterparty risk.",
...

  {
    ...
    intent: "Help users understand the difference between hot and cold crypto storage, why exchanges use both, and how this affects security and custody risk when choosing a platform.",
    directAnswer: "A hot wallet is a crypto wallet connected to the internet. A cold wallet is stored offline, disconnected from the internet. Hot wallets are convenient but more vulnerable to hacking. Cold wallets are significantly more secure but require deliberate effort to access. Reputable exchanges use a combination — keeping most funds in cold storage and a small percentage in hot wallets for operational liquidity.",
    ...
    risksAndCommonMistakes: "• Assuming an exchange is secure without checking their cold storage practices.\n• Not enabling 2FA — the most important personal protection against account compromise.\n• Storing large balances on exchanges long-term without understanding custodial risk.\n• Using exchange wallets as a permanent storage solution rather than moving to cold storage for large holdings.\n\nRisk note: no storage method is entirely risk-free. Hot wallets are vulnerable to online attacks; cold wallets are vulnerable to physical loss or damage.",
    realWorldExample: "Exchange A holds 95% of client assets in offline cold storage and 5% in a hot wallet with $100M insurance. Exchange B holds 60% in cold storage and 40% in accessible hot wallets. A successful hack of Exchange A's hot wallet would affect 5% of client assets, covered by insurance. The same hack on Exchange B could affect 40% — a far larger exposure.",
    whatToCheckBeforeTradingChecklist: "• What percentage of client assets does the exchange store in cold storage?\n• Does the exchange publish proof-of-reserves or third-party attestations?\n• Is there insurance on hot wallet holdings, and what is the coverage cap?\n• Is two-factor authentication available and required?\n• Can you whitelist withdrawal addresses to prevent unauthorised transfers?\n• Does the exchange have a track record of handling security incidents responsibly?",
    relatedConcepts: [
      { term: "Crypto Wallet", whyItMatters: "Hot and cold wallets are types of crypto wallets — understanding the broader wallet concept helps frame the distinction." },
      { term: "Blockchain", whyItMatters: "Hot and cold storage both hold keys to blockchain-recorded assets." },
      { term: "Private Key", whyItMatters: "The security difference between hot and cold wallets ultimately comes down to how and where private keys are stored." }
    ]
  },

  {
    slug: "staking",
    term: "Staking",
    intent: "Help users understand what crypto staking is, how it generates rewards, and what the risks and costs are when using an exchange to stake — relevant when comparing Coinbase, Kraken and Crypto.com.",
    directAnswer: "Staking is the process of locking cryptocurrency in a blockchain network to help validate transactions and maintain network security, in return for rewards — typically paid in the same token. For most retail users, staking happens through an exchange (like Coinbase or Kraken) which handles the technical process and pays out rewards after taking a commission. Staking yields vary by asset and carry liquidity, smart contract, and market risk.",
    ...
    howItWorks: "1) Proof-of-stake blockchains (like Ethereum, Solana, Cardano) use validators to confirm transactions.\n2) Validators are required to lock up ('stake') crypto as collateral to participate.\n3) In return, they earn rewards proportional to their stake.\n4) Most retail users delegate their stake to a validator through an exchange or staking service.\n5) The exchange pools user funds, stakes on their behalf, and distributes rewards after taking a commission.\n6) Rewards are typically paid daily, weekly, or periodically depending on the protocol.\n7) Some staking involves a lock-up period — funds cannot be withdrawn for a set duration.",
    whyThisMattersForTraders: "Staking can generate yield on assets you intend to hold long-term, but the commission taken by exchanges varies significantly — Coinbase retains 25-35% of rewards, while competitors often charge 10-15%. The headline APY shown by exchanges is after their commission, but this is not always clearly disclosed. Additionally, lock-up periods mean you cannot sell or transfer staked assets during volatile markets, which is a meaningful liquidity risk.",
    commonMisunderstandings: "• Staking is risk-free income: rewards are in crypto and the value of both rewards and staked assets can fall.\n• Higher APY means better returns: APY is usually in the staked token, whose price fluctuates.\n• All exchanges charge the same commission: they don't — check commission rates before staking.\n• Staking is the same as saving: unlike bank savings, there is no capital guarantee and no FSCS protection.\n• Lock-ups are always short: some assets require multi-week unbonding periods.",
...

  {
    ...
    howItWorks: "1) Bitcoin was the first cryptocurrency. Any coin created after it is an altcoin.\n2) Altcoins use their own blockchains or are built on existing ones (like Ethereum's ERC-20 tokens).\n3) Large altcoins like Ethereum have significant liquidity, broad exchange support, and established use cases.\n4) Mid-cap altcoins have more speculative profiles — higher potential return paired with higher risk.\n5) Small-cap or 'micro-cap' tokens can lose most or all of their value rapidly.\n6) Regulated exchanges apply listing standards — Coinbase lists fewer tokens than Crypto.com, but often applies stricter criteria.",
    whyThisMattersForTraders: "The altcoin range varies significantly between exchanges. Coinbase and Kraken list 200+ cryptocurrencies for UK users, applying relatively strict listing standards. Crypto.com lists 350+, covering a wider range including smaller projects. Exchanges with more permissive listings may offer earlier access to emerging projects but also list tokens that carry higher rug-pull or fraud risk. UK users should note that some altcoins may be restricted or unavailable under FCA rules.",
    commonMisunderstandings: "• All altcoins are speculative: Ethereum and Solana have substantial market caps and real-world use cases — though all crypto is volatile.\n• More altcoins = better exchange: a wider listing may indicate lower listing standards, not necessarily more value.\n• Altcoins follow Bitcoin's direction: they often do, but smaller altcoins can diverge dramatically.\n• Listed altcoins are FCA-approved: FCA registration of an exchange does not mean the FCA has assessed individual tokens.\n• Altcoin returns are higher than Bitcoin: historically some have outperformed and some have gone to zero.",
...

  {
    ...
    risksAndCommonMistakes: "• Confusing CFD crypto trading with spot crypto ownership — they are fundamentally different products.\n• Not accounting for trading fees when calculating break-even points.\n• Buying on illiquid spot markets with wide bid-ask spreads.\n• Leaving spot holdings on an exchange without understanding custodial risk.\n\nRisk note: spot crypto assets are volatile. Unlike leveraged products, losses are limited to the amount invested, but that amount can fall significantly. Crypto is not FSCS-protected.",
    realWorldExample: "Trader A buys £500 of Ethereum on Coinbase via spot trading. They own 0.2 ETH (at a hypothetical price of £2,500). If Ethereum's price falls 20%, their holding is worth £400 — a £100 loss. They can hold, sell, or withdraw to a personal wallet.\n\nTrader B takes a £500 Ethereum CFD on a spread betting platform with 2:1 leverage. Their exposure is £1,000 of ETH. The same 20% fall results in a £200 loss — double the spot trader's loss — plus any overnight financing charges.",
    whatToCheckBeforeTradingChecklist: "• Is the platform a spot exchange (you own the asset) or a CFD/derivatives provider (you have price exposure only)?\n• What are the spot trading fees (maker-taker rates or flat fee)?\n• Are GBP spot pairs available for the assets you want, or are you converting to USD first?\n• What are the withdrawal options and fees for your assets?\n• Do you understand custody risk on the exchange you are using?",
    relatedConcepts: [
      { term: "Blockchain", whyItMatters: "Spot trading results in actual blockchain-recorded ownership — the defining difference from CFDs." },
      { term: "Crypto Wallet", whyItMatters: "Spot assets can be withdrawn to personal wallets; understanding wallet types is relevant to long-term spot holders." },
      { term: "Altcoin", whyItMatters: "Most altcoin trading happens via spot markets — pair availability and liquidity vary by exchange." },
      { term: "CFD", whyItMatters: "CFDs offer crypto price exposure without ownership — understanding the distinction helps UK users choose the right product type." }
    ]
  }
];